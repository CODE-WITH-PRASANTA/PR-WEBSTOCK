...
import ProjectChat from '../ProjectChat/ProjectChat'; // Integrated Chat Module
  ...
  return (
    <div className="ProjectFiles-container">
      ...
      <div className="ProjectFiles-header">
        <h2 className="ProjectFiles-title">Project Workspace</h2>
        <div className="ProjectFiles-breadcrumb">
          ...
          <MdChevronRight className="ProjectFiles-arrow-icon" />
          <span className="ProjectFiles-current">Files & Stream</span>
        </div>
      </div>

      {/* Split Dual Layout Workspace Grid */}
      <div className="ProjectFiles-workspace-grid">
        {/* LEFT COLUMN: Data File Manager */}
        <div className="ProjectFiles-workspace-card">
          <div className="ProjectFiles-toolbar">
            ...
            <div className="ProjectFiles-right-tools" ref={dropdownRef}>
              ...
              <button
                className="ProjectFiles-tool-btn text-blue-light"
          ...
          {errorMsg && (
            <div className="ProjectFiles-alert-error" style={{ padding: '12px', color: 'red' }}>
              {errorMsg}
            </div>
          )}
          ...
          <div className="ProjectFiles-table-wrapper">
            <table className="ProjectFiles-table">
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan="9" className="ProjectFiles-empty-state">
                      Loading files...
                    </td>
                  </tr>
                ) : (
                  filteredFiles.map((file, index) => (
                    <tr key={file._id} className={selectedIds.includes(file._id) ? 'row-selected' : ''}>
                      ...
                      {visibleColumns.download && (
                        <td>
                          <button
                            className="ProjectFiles-action-icon-btn gray-btn"
                      ...
                      {visibleColumns.actions && (
                        <td>
                          <div className="ProjectFiles-action-cell-flex">
                            <button
                              className="ProjectFiles-action-icon-btn blue-btn"
                              onClick={() => openEditModal(file)}
                            >
                              <LuSquarePen />
                            </button>
                            <button
                              className="ProjectFiles-action-icon-btn red-btn"
          ...
          <div className="ProjectFiles-pagination-bar">
            <div className="ProjectFiles-pagination-right">
              ...
              <div className="ProjectFiles-pagination-arrows">
                <button disabled className="ProjectFiles-arrow-btn">
                  ‹
                </button>
                <button disabled className="ProjectFiles-arrow-btn">
                  ›
        ...
        {/* RIGHT COLUMN: Real-Time WebSockets Chat Section */}
        <div className="ProjectFiles-chat-column">
          <ProjectChat />
        </div>
      </div>
      ...
      <div className={`ProjectFiles-modal-overlay ${activeModal === 'add' ? 'show' : ''}`}>
        <div className="ProjectFiles-modal-card max-width-lg">
          <div className="ProjectFiles-modal-header bg-gradient-blue">
            <h3>New File</h3>
            <button className="ProjectFiles-modal-close" onClick={() => setActiveModal(null)}>
              <IoClose />
            </button>
          </div>
          <form onSubmit={handleAddSubmit} className="ProjectFiles-modal-form">
            ...
            <div className="ProjectFiles-modal-footer">
              <button type="submit" className="ProjectFiles-btn bg-save">
                Save
              </button>
              <button type="button" className="ProjectFiles-btn bg-cancel" onClick={() => setActiveModal(null)}>
                Cancel
              </button>
            </div>
          </form>
      ...
      <div className={`ProjectFiles-modal-overlay ${activeModal === 'edit' ? 'show' : ''}`}>
        <div className="ProjectFiles-modal-card max-width-lg">
          ...
          <form onSubmit={handleEditSubmit} className="ProjectFiles-modal-form">
            ...
            >
              ...
              <p>
                {selectedFile ? (
                  ...
                  <>
                    Click to replace existing physical file or <span className="browse-link">browse</span>
                  </>
                )}
              </p>
              <span className="formats-note">Supported formats: PDF, DOCX, ZIP, PNG (Max 10MB)</span>
            ...
            <div className="ProjectFiles-modal-footer">
              <button type="submit" className="ProjectFiles-btn bg-save-active">
                Save
              </button>
              <button type="button" className="ProjectFiles-btn bg-cancel" onClick={() => setActiveModal(null)}>
                Cancel
      ...
      <div className={`ProjectFiles-modal-overlay ${activeModal === 'delete' ? 'show' : ''}`}>
        <div className="ProjectFiles-modal-card max-width-sm text-align-left border-radius-sm p-24">
          ...
          <div className="ProjectFiles-delete-body">
            <p>
              <strong>File Name:</strong> {targetFile?.name}
            </p>
            <p>
              <strong>Uploaded By:</strong> {targetFile?.uploadedBy}
            </p>
          </div>
          <div className="ProjectFiles-modal-footer flex-row-reverse-start gap-12 mt-24">
            <button
              type="button"
              className="ProjectFiles-btn bg-cancel text-white px-24 border-radius-round"
            ...
            <button
              type="button"
              className="ProjectFiles-btn bg-delete-red text-white px-24 border-radius-round"
