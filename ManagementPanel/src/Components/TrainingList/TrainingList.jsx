...
const initialTrainings = [
  ...
  { id: 6, type: "Leadership Development", trainer: "John Doe", employees: 4, duration: "8 hours", cost: "$500", status: "Completed", date: "2024-10-10", certification: "Yes", audience: "Senior Managers", completionDate: "2024-10-11", contact: "johndoe@example.com", dept: "HR", prerequisites: "Basic Leadership Skills", desc: "An intensive leadership program to enhance management skills." },
  { id: 7, type: "Advanced Data Analytics", trainer: "Sara White", employees: 3, duration: "6 hours", cost: "$400", status: "Scheduled", date: "2026-11-01", certification: "No", audience: "Data Analysts", completionDate: "2026-11-01", contact: "saraw@example.com", dept: "Analytics", prerequisites: "Python Basics", desc: "Deep dive into statistical models and machine learning fundamentals." },
  { id: 8, type: "Sales Training", trainer: "Evan Clark", employees: 2, duration: "4 hours", cost: "$300", status: "Completed", date: "2025-09-25", certification: "Yes", audience: "Sales Reps", completionDate: "2025-09-25", contact: "evan@example.com", dept: "Sales", prerequisites: "None", desc: "Mastering the art of closing high-value deals." },
  { id: 9, type: "Cybersecurity Basics", trainer: "Alice Green", employees: 5, duration: "5 hours", cost: "$250", status: "In Progress", date: "2026-11-05", certification: "Yes", audience: "All Employees", completionDate: "2026-11-06", contact: "alice@example.com", dept: "IT Security", prerequisites: "None", desc: "Phishing awareness and basic digital defense practices." },
  { id: 10, type: "Time Management", trainer: "Brian Foster", employees: 4, duration: "3 hours", cost: "$150", status: "Completed", date: "2026-08-20", certification: "No", audience: "Managers", completionDate: "2026-08-20", contact: "brian@example.com", dept: "Operations", prerequisites: "None", desc: "How to structure schedules and optimize delegation workflows." }
];
