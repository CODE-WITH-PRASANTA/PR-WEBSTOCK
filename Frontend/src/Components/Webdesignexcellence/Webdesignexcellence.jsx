      ...
      <div className="Webdesignexcellence__inner">
        ...
        <div className="Webdesignexcellence__left">
          <div className="Webdesignexcellence__header">
            ...
            <h2
              id="Webdesignexcellence-heading"
              className="Webdesignexcellence__title"
            >
              <span className="Webdesignexcellence__title-line">
                Building Powerful Web Solutions{" "}
              </span>
            ...
            <p className="Webdesignexcellence__description">
              At PR WEBSTOCK , we design and develop modern websites
              that help businesses grow online. As a trusted web design company
              in Bhubaneswar, we focus on coding-based development to deliver
              fast, secure, and scalable digital solutions. Our team creates
              clean, responsive websites using the latest technologies, ensuring
              smooth performance across all devices. From simple business
              websites to advanced web applications, we provide top website
                ...
                <div className="Webdesignexcellence__stat-container">
                  ...
                  >
                    <div className="Webdesignexcellence__stat-circle-inner">
                      <svg
                        className="Webdesignexcellence__progress-ring"
                        viewBox="0 0 100 100"
                      >
                        <circle
                      ...
                      <div className="Webdesignexcellence__stat-content">
                        ...
                        <div className="Webdesignexcellence__stat-suffix">
                          +
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="Webdesignexcellence__stat-labels">
                    <div className="Webdesignexcellence__stat-top">
                      {s.labelTop}
                    </div>
                    <div className="Webdesignexcellence__stat-bottom">
                      {s.labelBottom}
                    </div>
                  </div>
                </div>
          ...
          <div className="Webdesignexcellence__cta">
            ...
            <div className="Webdesignexcellence__trust">
              ...
              <span>Delivering Quality Web Solutions</span>
            </div>
          </div>
        </div>
        ...
        <div className="Webdesignexcellence__right" aria-hidden="true">
          <div className="Webdesignexcellence__illustration-container">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M15 5L20 10L15 15L10 10L15 5"
                      fill="#339933"
                      opacity="0.7"
                    />
                  </pattern>
                ...
                <g filter="url(#wdxShadow)">
                  ...
                  <g>
                    ...
                    >
                      ...
                      <text x="170" y="150" fill="#60A5FA">
                        import
                      </text>
                      <text x="220" y="150" fill="#FFFFFF">
                        React
                      </text>
                      <text x="260" y="150" fill="#60A5FA">
                        from
                      </text>
                      <text x="290" y="150" fill="#F87171">
                        'react'
                      </text>

                      <text x="170" y="170" fill="#10B981">
                        const
                      </text>
                      <text x="210" y="170" fill="#FBBF24">
                        App
                      </text>
                      <text x="240" y="170" fill="#FFFFFF">
                        =
                      </text>
                      <text x="255" y="170" fill="#FFFFFF">
                        ()
                      </text>
                      <text x="270" y="170" fill="#FFFFFF">
                        =&gt;
                      </text>

                      <text x="185" y="190" fill="#A78BFA">
                        return
                      </text>
                      <text x="235" y="190" fill="#FFFFFF">
                        (
                      </text>

                      <text x="200" y="210" fill="#FFFFFF">
                        &lt;
                      </text>
                      <text x="210" y="210" fill="#34D399">
                        div
                      </text>
                      <text x="240" y="210" fill="#60A5FA">
                        className
                      </text>
                      <text x="290" y="210" fill="#F87171">
                        ="app"
                      </text>
                      <text x="320" y="210" fill="#FFFFFF">
                        &gt;
                      </text>

                      <text x="200" y="230" fill="#FFFFFF">
                        &lt;/
                      </text>
                      <text x="210" y="230" fill="#34D399">
                        div
                      </text>
                      <text x="240" y="230" fill="#FFFFFF">
                        &gt;
                      </text>

                      <text x="185" y="250" fill="#FFFFFF">
                        )
                      </text>
                    </g>
                ...
                <g>
                  ...
                  <g transform="translate(300, 380)">
                    <path
                      d="M-25,-5 Q-35,5 -25,15 Q-10,25 5,15 Q15,25 25,15 Q35,5 25,-5 Q15,-15 0,-15 Q-15,-15 -25,-5"
                      fill="#E0E7FF"
                      opacity="0.8"
                    />
                ...
                <g>
                  <g transform="translate(450, 80)">
                    <path
                      d="M-15,-15 L0,-25 L15,-15 L12,15 L0,20 L-12,15 Z"
                      fill="#E34F26"
                    />
                    <text
                      x="0"
            ...
            <div className="Webdesignexcellence__stats-overlay">
              ...
              <div className="Webdesignexcellence__stats-item">
                <div className="Webdesignexcellence__stats-value">
                  &lt;100ms
                </div>
                <div className="Webdesignexcellence__stats-label">
                  Response Time
                </div>
              </div>
            </div>
